...
class EmployeeControllerTest {
    ...
    void testGetAllEmployees() {
        ...
        webTestClient.get()
                ...
                .jsonPath("$.data[0].id").isEqualTo(sampleEmployee.getId())
                .jsonPath("$.data[0].name").isEqualTo(sampleEmployee.getName())
                .jsonPath("$.data[0].salary").isEqualTo(sampleEmployee.getSalary())
                .jsonPath("$.data[0].age").isEqualTo(sampleEmployee.getAge());
    }
    ...
    void testGetEmployeeById_Success() {
        ...
        webTestClient.get()
                ...
                .jsonPath("$.data.id").isEqualTo(sampleEmployee.getId())
                .jsonPath("$.data.name").isEqualTo(sampleEmployee.getName())
                .jsonPath("$.data.salary").isEqualTo(sampleEmployee.getSalary())
                .jsonPath("$.data.age").isEqualTo(sampleEmployee.getAge());
    }
    ...
    void testGetHighestSalaryOfEmployees() {
        ...
        webTestClient.get()
                ...
                .jsonPath("$.status").isEqualTo("SUCCESS")
                .jsonPath("$.data").isNotEmpty()
                .jsonPath("$.data").isEqualTo(100000);
    }
    ...
    void testGetTopTenHighestEarningEmployeeNames_Success() {
        ...
        webTestClient.get()
                ...
                .expectBody()
                .jsonPath("$.data").isArray()
                .jsonPath("$.data[0]").isEqualTo("John")
                .jsonPath("$.data[1]").isEqualTo("Jane")
                .jsonPath("$.data[2]").isEqualTo("Bob")
                .jsonPath("$.status").isEqualTo("SUCCESS");
    }
    ...
    void testCreateEmployee_Success() {
        EmployeeDto input = EmployeeDto.builder().name("Alice").age(28).salary(40000).build();
        Employee created = Employee.builder().id("3").name("Alice").age(28).salary(40000).build();
        ...
        webTestClient.post()
                ...
                .jsonPath("$.status").isEqualTo("SUCCESS")
                .jsonPath("$.data").isNotEmpty()
                .jsonPath("$.data.id").isEqualTo(created.getId())
                .jsonPath("$.data.name").isEqualTo(created.getName())
                .jsonPath("$.data.salary").isEqualTo(created.getSalary())
                .jsonPath("$.data.age").isEqualTo(created.getAge());
    }
    ...
    void testDeleteEmployeeById_Success() {
        ...
        webTestClient.delete()
                ...
                .jsonPath("$.status").isEqualTo("SUCCESS")
                .jsonPath("$.data").isNotEmpty()
                .jsonPath("$.data").isEqualTo(sampleEmployee.getName());
    }
    ...
    void testGetEmployeeById_BadGateway() {
        String id = sampleEmployee.getId();
        when(employeeService.getEmployeeById(id)).thenThrow(new ExternalServiceException("502 - Service Unavailable",null));
        webTestClient.get()
                .uri("/{id}", id)
                .exchange()
                .expectStatus().is5xxServerError().expectStatus().isEqualTo(502);
    }
    ...
    void testGetEmployeeById_TooManyRequests() {
        ...
        webTestClient.get()
                .uri("/{id}", id)
                .exchange()
                .expectStatus().is4xxClientError().expectStatus().isEqualTo(429);
    }
}